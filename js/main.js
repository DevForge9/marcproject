...
$(window).on('load',function (){
    ...
    if ($('.home-page').length > 0) {
        if ($(window).width() > 768 && window.orientation !== 0) {
            MarcBassil.registerPlugin(ScrollTrigger);
            MarcBassil.registerPlugin(ScrollToPlugin);

            MarcBassil.delayedCall(0.5, function () {
                MarcBassil.to('.main--home', {duration: 0.5,autoAlpha: 1},0);
            });


            let titles = MarcBassil.utils.toArray(".page-title li"),
                sections = MarcBassil.utils.toArray(".scrollable"),
                projectBlocks = MarcBassil.utils.toArray(".projects__blocks .projects__block"),
                newsBlocks = MarcBassil.utils.toArray(".news__blocks .news__block");
            ...
            MarcBassil.delayedCall(0.4, function () {
                let tl1 = new TimelineMax();
                let titles = MarcBassil.utils.toArray(".home .content__title > *");
            ...
            MarcBassil.delayedCall(0.5, function () {
                let numbers = MarcBassil.utils.toArray(".home__number-digital[data-number]");

                numbers.forEach((number, index) => {
                    let Cont = {val: 0},
                        NewVal = $(number).data('number');

                    MarcBassil.to(Cont, 2, {
            ...
            MarcBassil.delayedCall(0.8, function () {
                MarcBassil.to(".home__circles-lines div", {height: '100%', duration: 2, opacity: 1});
            });
            MarcBassil.delayedCall(1, function () {
                MarcBassil.to(".home__circle--left", {left: '50%', duration: 2, opacity: 1});
                MarcBassil.to(".home__circle--right", {right: '50%', duration: 2, opacity: 1});
            });
            ...
            //projects
            let titlesProjects = MarcBassil.utils.toArray(".projects .content__title > *");
            ...
            let tlTitle3 = MarcBassil.timeline({paused: true});
            ...
            let titlesAwards = MarcBassil.utils.toArray(".awards .content__title > *");
            ...
            let awardsAwards = MarcBassil.utils.toArray(".awards__list .content__award");
            ...
            //testimonials start
            sectionNumber++;
            let tlTitle4 = MarcBassil.timeline({paused: true});
            ...
            let titlesTesti = MarcBassil.utils.toArray(".testimonials .content__title > *");
            ...
            let clientsTesti = MarcBassil.utils.toArray(".testimonials__clients > .testimonials__client");
            clientsTesti.forEach((client, index) => {
                tl4.from(client, {autoAlpha: 0, bottom: -600 - 200 * index, ease: Power1.easeOut}, 0);
            });


            let tl41 = MarcBassil.timeline();
            ...
            let tlTitle5 = MarcBassil.timeline({paused: true});
            ...
            let titlesExp = MarcBassil.utils.toArray(".experience .content__title > *");
            ...
            let awardsExp = MarcBassil.utils.toArray(".experience__list .content__award");
            ...
            let tlTitle6 = MarcBassil.timeline({paused: true});
            ...
            let titlesNews = MarcBassil.utils.toArray(".news .content__title > *");
            ...
            let tlScroll = MarcBassil.timeline();
            ...
            let tlScrollLast = MarcBassil.timeline();
            ...
            MarcBassil.set(titles, {y: "100%"});

            MarcBassil.delayedCall(0.2, function () {
                MarcBassil.to(titles[0], {y: "0", duration: 0.2});
            });

            MarcBassil.set(sections, {xPercent: 0});
            ...
            $(document).on('click', '.js-scroll-link', function () {
                ...
                if (!blockNavigation && !skipMode){
                    $('.header__menu').addClass('blocked');
                    MarcBassil.fromTo('.home-page', {autoAlpha: 1}, {duration: 0.4,autoAlpha: 0},0);
                    skipMode = true;
                    ...
                    setTimeout(function (){
                        ...
                        MarcBassil.set(titles, {y: "100%"});
                        MarcBassil.set(titles[parseInt(link)], {y: "0"});
                        MarcBassil.set(sections, {xPercent: -100 * parseInt(link), ease: "none"}, 0);
                        $('.header__menu li').removeClass('active');
                        $('.header__menu li').eq(parseInt(link)).addClass('active');

                        MarcBassil.fromTo('.home-page', {autoAlpha: 0}, {duration: 0.5,autoAlpha: 1},0);
                        setTimeout(function (){
                            skipMode = false;
                            $('.header__menu').removeClass('blocked');
                        },500);
...
$(function (){
    if ($('.home-page').length > 0){
        ...
        function animateSlides(direction) {
            slideAnimation.kill();
            var x = snapX(MarcBassil.getProperty(proxy,'x') + direction * slideWidth);
            slideAnimation = MarcBassil.to(proxy, {duration: slideDuration, x: x,onUpdate: updateProgress});
        }

        function updateProgress() {
            animation.progress(MarcBassil.getProperty(proxy,'x') / wrapWidth);
        }
        ...
        function resize() {
            var norm = (MarcBassil.getProperty(proxy,'x') / wrapWidth) || 0;
